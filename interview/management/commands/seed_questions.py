    ...
    def handle(self, *args, **kwargs):
        ...
        roles_data = [
            {
                ...
                "description": "Backend programming and architecture",
            },
            {
                "name": "Data Scientist",
                "slug": "data-scientist",
                "description": "Data science, ML, and statistics",
            },
            {
                "name": "DevOps Engineer",
                "slug": "devops-engineer",
                "description": "CI/CD, cloud, and infrastructure",
            },
            {
        ...
        questions_data = {
            backend_role: [
                ...
                (
                    "Explain the role of an API gateway in backend systems.",
                    "hard",
                    ["API Gateway", "routing", "security"],
                ),
                (
                    "What are common HTTP methods and when are they used?",
                    "easy",
                    ["GET", "POST", "PUT", "DELETE"],
                ),
                (
                ...
                (
                    "What strategies do you use for caching in backend systems?",
                    "hard",
                ...
                (
                    "What are common backend scalability challenges?",
                    "medium",
                    ["scalability", "load balancing", "bottlenecks"],
                ),
            ],
            data_role: [
                (
                ...
                (
                    "Explain overfitting and underfitting in ML models.",
                    "medium",
                ...
                (
                    ...
                    "hard",
                    ["clustering", "silhouette score", "evaluation"],
                ),
            ],
            devops_role: [
                (
                ...
                (
                    "How do you monitor system performance in production?",
                    "hard",
                ...
                (
                    ...
                    "easy",
                    ["load balancing", "HAProxy", "scalability"],
                ),
                (
                ...
                (
                    "What are common security practices in DevOps?",
                    "medium",
                    ["DevSecOps", "secrets management", "firewalls"],
                ),
                (
                ...
                (
                    "How do you handle logging and alerting?",
                    "hard",
                    ["logging", "ELK stack", "alerts"],
                ),
            ],
            frontend_role: [
                (
                ...
                (
                    "How do you optimize performance in large React apps?",
                    "hard",
                ...
                (
                    "Explain CSS flexbox and grid systems.",
                    "medium",
                    ["flexbox", "grid", "layout"],
                ),
                (
                    "What are common differences between client-side and server-side rendering?",
                    "medium",
                    ["CSR", "SSR", "rendering"],
                ),
                (
        ...
        for role, questions in questions_data.items():
            for question_text, difficulty, keywords in questions:
                ...
                if created:
                    self.stdout.write(
                        f"Created question for {role.name}: {question_text[:50]}..."
                    )

        self.stdout.write(
            self.style.SUCCESS(
                "Successfully seeded the database with roles and questions!"
            )
        )
