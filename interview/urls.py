...
urlpatterns = [
    ...
    path(
        "api/answer-browsable/", views.api_answer_browsable, name="api_answer_browsable"
    ),
    path("api/session/start", views.api_start_session, name="api_start_session"),
    path(
        "api/session/<int:session_id>/summary",
        views.api_session_summary,
        name="api_session_summary",
    ),
